            ...
            <div class="slide-visual">
              ...
              <!--   <div class="script-wrap">
                    ...
                    <div class="slide-controller">
                        <a href="#" class="btn-prev"><img src="images/btn_prev.png" style = "width: 30px; height: 30px;" alt="Prev Slide" /></a> 
                        <a href="#" class="btn-play"><img src="images/btn_play.png" style = "width: 30px; height: 30px;"alt="Start Slide" /></a> 
                        <a href="#" class="btn-pause"><img src="images/btn_pause.png" style = "width: 30px; height: 30px;"alt="Pause Slide" /></a> 
                        <a href="#" class="btn-next"><img src="images/btn_next.png" style = "width: 30px; height: 30px;"alt="Next Slide" /></a>
                    </div>
                </div> -->
                <div class="clearfix"></div>
            </div>
